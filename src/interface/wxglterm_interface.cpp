...
#endif
{
    ...
    py::enum_<InputHandler::ModifierEnum>(input_handler, "Modifier")
            .value("MOD_SHIFT", InputHandler::ModifierEnum::MOD_SHIFT_V)
            .value("MOD_CONTROL", InputHandler::ModifierEnum::MOD_CONTROL_V)
            .value("MOD_ALT", InputHandler::ModifierEnum::MOD_ALT_V)
            .value("MOD_SUPER", InputHandler::ModifierEnum::MOD_SUPER_V)
            .export_values();
