...
#endif
{
    ...
    py::enum_<InputHandler::ModifierEnum>(input_handler, "Modifier")
            .value("M_SHIFT", InputHandler::ModifierEnum::M_SHIFT)
            .value("M_CONTROL", InputHandler::ModifierEnum::M_CONTROL)
            .value("M_ALT", InputHandler::ModifierEnum::M_ALT)
            .value("M_SUPER", InputHandler::ModifierEnum::M_SUPER)
            .export_values();
