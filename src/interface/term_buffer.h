...
public:
    ...
    virtual void ScrollBuffer(int32_t offset, const TermCellPtr & cell_template) = 0;
    virtual void DeleteLines(uint32_t begin, uint32_t count, const TermCellPtr & cell_template) = 0;
    virtual void InsertLines(uint32_t begin, uint32_t count, const TermCellPtr & cell_template) = 0;
    virtual bool MoveCurRow(uint32_t offset, bool move_down, bool scroll_buffer, const TermCellPtr &cell_template) = 0;
    ...
    virtual void SetCurCellData(uint32_t ch, bool wide_char, bool insert, const TermCellPtr & cell_template) = 0;
